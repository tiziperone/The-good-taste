    ...
    <div class="row justify-content-center gap-4">
      ...
      <div class="col-12 col-md-5 col-lg-4">
        <div class="card text-bg-dark border-warning shadow-sm h-100 position-relative">
          <img src="{{ secure_asset($mila->url_imagen ? $mila->url_imagen : 'Img/milanesa de carne sin freir.jpeg') }}" class="card-img-top" style="height: 250px; object-fit: cover;" alt="{{ $mila->nombre }}">
