        ...
        <div class="card text-bg-dark border-warning shadow-sm h-100 position-relative">
          ...
          <div class="card-body d-flex flex-column">
            ...
            <div class="mt-auto">
              ...
              <button type="button" class="btn btn-outline-light ms-2 btn-agregar-carrito" data-id="{{ $bondiolaClasica ? $bondiolaClasica->id : '' }}">
        ...
        <div class="card text-bg-dark border-warning shadow-sm h-100 position-relative">
          ...
          <div class="card-body d-flex flex-column">
            ...
            <div class="mt-auto">
              @auth
              <a href="{{ url('/compra') }}" class="btn btn-warning fw-bold text-dark">Comprar</a>
              <button type="button" class="btn btn-outline-light ms-2 btn-agregar-carrito" data-id="{{ $bondiolaPimenton ? $bondiolaPimenton->id : '' }}">
                Agregar <i class="bi bi-cart"></i>
              </button>
              @else
              <button type="button" class="btn btn-warning fw-bold text-dark btn-requiere-auth">Comprar</button>
