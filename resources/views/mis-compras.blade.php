...
@section('titulo', 'The Good Taste - Mis Compras')
...
<div class="container mt-5 mb-5" style="min-height: 50vh;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-dark table-sm table-borderless align-middle mb-0">
                            <tbody>
                                ...
                                <tr>
                                    <td style="width: 40px;">
                                        <img src="{{ asset($detalle->url_imagen ?? 'Img/BondiolaTarjetaSinPimenton.png') }}" class="rounded" style="width: 40px; height: 40px; object-fit: cover;">
                                    </td>
    ...
    <div class="card text-bg-dark border-secondary p-5 text-center shadow-lg my-5" style="border-radius: 15px;">
        ...
        <a href="{{ url('/catalogo') }}" class="btn btn-warning fw-bold text-dark px-4 py-2 shadow">Ir al Catálogo</a>
    </div>
    @endif
</div>
@endsection